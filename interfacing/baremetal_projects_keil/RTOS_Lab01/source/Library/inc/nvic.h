/* @file 			 : NVIC.h
*  @Description: This file includes the definitions of the NVIC used IRQ(Interrupt Request) of all
*                Peripherals , Registers definitions as MACROS and function prototypes.
