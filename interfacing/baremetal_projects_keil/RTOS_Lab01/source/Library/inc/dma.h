/* @file 			 : dma.h
*  @Description: This file includes the definitions of the DMA Base Addreses ,Registers access 	
*  
...
#define CLOCK_BUS_HIGH      RCC->AHBENR 
#define DMACLOCK_ENABLE      (1<<0)
...
void dma_channel_reset(uint32_t dma, u8 channel);
void dma_enable_mem2mem_mode(uint32_t dma, u8 channel);
void dma_set_priority(uint32_t dma, u8 channel, u32 prio);
void dma_set_memory_size(uint32_t dma, u8 channel, u32 mem_size);
void dma_set_peripheral_size(uint32_t dma, u8 channel, u32 peripheral_size);
void dma_enable_memory_increment_mode(uint32_t dma, u8 channel);
void dma_enable_peripheral_increment_mode(uint32_t dma, u8 channel);
void dma_enable_circular_mode(uint32_t dma, u8 channel);
void dma_set_read_from_peripheral(uint32_t dma, u8 channel);
void dma_set_read_from_memory(uint32_t dma, u8 channel);
void dma_enable_transfer_error_interrupt(uint32_t dma, u8 channel);
void dma_disable_transfer_error_interrupt(uint32_t dma, u8 channel);
